...
import com.restugedepurnama.event.databinding.ItemSearchRvBinding

class SearchAdapter(
    private val onClickedItem: (EventEntity) -> Unit
) : ListAdapter<EventEntity, SearchAdapter.ViewHolder>(DiffCallback()){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemSearchRvBinding.inflate(LayoutInflater.from(parent.context), parent, false)
